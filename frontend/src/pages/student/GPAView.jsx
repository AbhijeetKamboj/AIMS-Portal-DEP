                    ...
                    <div className="relative z-10">
                        <div className="flex items-start justify-between">
                            <div className="flex-1">
                                ...
                                <p className="text-teal-100 text-xs leading-relaxed">Credits are finalized and reflected here when the semester is locked by the academic office or the grades are uploaded by admin</p>
                            </div>
                        ...
                        {transcript.semesters.map((sem, idx) => (
                            <div key={idx} className="bg-white rounded-2xl shadow-soft border border-gray-100 overflow-hidden hover:shadow-lg transition-all duration-300">
                                ...
                                <div className="px-6 py-3 bg-blue-50 border-b border-blue-100 text-xs text-blue-800">
                                    <span className="font-semibold">Credits Info:</span> Credits shown are for courses you are enrolled in or pending approvals. Final credits are counted when semester is locked or grades are uploaded by admin.
                                </div>
