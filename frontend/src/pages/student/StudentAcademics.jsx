        ...
        <div className="space-y-8">
            <div className="flex items-start gap-4 p-4 bg-amber-50 rounded-xl border border-amber-100 text-amber-800">
                ...
                <div className="text-sm">
                    ...
                    <p>Some of the grades shown here may be pending approval by the senate. The records confirmed by the academic section will take precedence.</p>
                </div>
            </div>

            {semesters.map((sem, idx) => (
                <div key={idx} className="bg-white rounded-2xl shadow-soft border border-gray-100 overflow-hidden animate-slide-up" style={{ animationDelay: `${idx * 100}ms` }}>
