                    ...
                    {activeTab === "enrollment" && (
                        <div className="space-y-6">
                            <div className="flex p-1 bg-gray-100 rounded-xl w-fit">
                                ...
                                <button
                                    onClick={() => setSubTab("enrollment", "direct-enroll")}
                                    className={`px-4 py-2 rounded-lg text-sm font-bold transition-all ${subTabs.enrollment === "direct-enroll" ? "bg-white text-black shadow-sm" : "text-gray-500 hover:text-gray-700"}`}
                                >
                                    Direct Enroll
                                </button>
                            </div>
                            ...
                            <div className="bg-white rounded-2xl border border-gray-100 shadow-soft p-6 min-h-[500px]">
                                {subTabs.enrollment === "bulk-enroll" ? <FacultyBulkEnroll /> : <DirectEnroll />}
                            </div>
                        </div>
                    )}
