                ...
                <div className="card p-8 shadow-strong">
                    ...
                    <div className="flex p-1 bg-gray-100 rounded-xl mb-6">
                        <button
                            ...
                            className={`flex-1 py-2 px-4 rounded-lg text-sm font-bold transition-all cursor-pointer ${loginMethod === "password"
                        ...
                        <button
                            ...
                            className={`flex-1 py-2 px-4 rounded-lg text-sm font-bold transition-all cursor-pointer ${loginMethod === "otp"
                                    ? "bg-white text-black shadow-sm"
                                    : "text-gray-500 hover:text-gray-700"
                                }`}
                        >
